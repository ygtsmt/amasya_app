...
import 'package:amasyaapp/app/bloc/app_bloc.dart' as _i23;
import 'package:amasyaapp/app/data/app_usecase.dart' as _i13;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i13.AppUseCase>(() => _i13.AppUseCase(
          gh<_i10.SecureDataStorage>(),
          gh<_i11.SnackBarService>(),
        ));
    gh.factory<_i14.DuyuruListUseCase>(
        () => _i14.DuyuruListUseCase(gh<_i15.SnackBarService>()));
    gh.factory<_i16.HaberListUseCase>(
        () => _i16.HaberListUseCase(gh<_i15.SnackBarService>()));
    gh.factory<_i17.HalFIyatlariListUseCase>(
        () => _i17.HalFIyatlariListUseCase(gh<_i15.SnackBarService>()));
    gh.singleton<_i18.HalFiyatlariListBloc>(
        _i18.HalFiyatlariListBloc(gh<_i17.HalFIyatlariListUseCase>()));
    gh.singleton<_i19.HttpDataSource>(_i19.HttpDataSource(
      gh<_i6.Dio>(),
    ...
    gh.factory<_i21.SplashUseCase>(() => _i21.SplashUseCase(
          gh<_i19.HttpDataSource>(),
          gh<_i10.SecureDataStorage>(),
        ));
    gh.factory<_i22.VehicleListUseCase>(() => _i22.VehicleListUseCase(
          gh<_i15.HttpDataSource>(),
          gh<_i15.SnackBarService>(),
        ));
    gh.singleton<_i23.AppBloc>(_i23.AppBloc(gh<_i13.AppUseCase>()));
    gh.factory<_i24.CreateAccountUseCase>(() => _i24.CreateAccountUseCase(
          gh<_i15.HttpDataSource>(),
          gh<_i15.SnackBarService>(),
        ));
    gh.factory<_i25.CreateGarageUseCase>(() => _i25.CreateGarageUseCase(
          gh<_i15.HttpDataSource>(),
          gh<_i15.SnackBarService>(),
        ));
    gh.singleton<_i26.DuyuruListBloc>(
        _i26.DuyuruListBloc(gh<_i14.DuyuruListUseCase>()));
    gh.singleton<_i27.HaberListBloc>(
        _i27.HaberListBloc(gh<_i16.HaberListUseCase>()));
    gh.singleton<_i28.LoginBloc>(_i28.LoginBloc(
      gh<_i20.LoginUseCase>(),
      gh<_i13.AppUseCase>(),
    ));
    gh.singleton<_i29.SplashBloc>(_i29.SplashBloc(gh<_i21.SplashUseCase>()));
    gh.singleton<_i30.VehicleListBloc>(
        _i30.VehicleListBloc(gh<_i22.VehicleListUseCase>()));
    gh.singleton<_i31.CreateAccountBloc>(_i31.CreateAccountBloc(
      gh<_i24.CreateAccountUseCase>(),
      gh<_i20.LoginUseCase>(),
    ));
    gh.singleton<_i32.CreateGarageBloc>(
        _i32.CreateGarageBloc(gh<_i25.CreateGarageUseCase>()));
    return this;
  }
}
