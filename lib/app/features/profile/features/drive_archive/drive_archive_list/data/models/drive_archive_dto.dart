...
part "drive_archive_dto.g.dart";

@JsonSerializable()
class DriveArchiveDto extends Equatable {
  const DriveArchiveDto({
  ...
  factory DriveArchiveDto.fromJson(final Map<String, dynamic> json) => _$DriveArchiveDtoFromJson(json);
  ...
  Map<String, dynamic> toJson() => _$DriveArchiveDtoToJson(this);
