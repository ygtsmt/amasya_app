...
@injectable
class DriveArchiveListUseCase {
  DriveArchiveListUseCase(this._httpDataSource, this._snackBarService);
  ...
  Future<Result<List<DriveDto>?, String?>> getDrives() async {
    try {
      ...
      final result = await _httpDataSource.request(
        RequestMethod.get,
        "/api/Drive/GetDrivesByGarageId?PageNumber=1&PageSize=1000&Property=Id&Asc=false&garageId=$garageId&isDeleted=true",
      );
